...
/// @nodoc
@JsonSerializable()
class _$_DeliveryTimeModel extends _DeliveryTimeModel {
  ...
  @override
  String toString() {
    return 'DeliveryTimeModel(id: $id, name: $name, name_ar: $name_ar, active: $active, created_at: $created_at, updated_at: $updated_at, deleted_at: $deleted_at)';
  }
...
abstract class _DeliveryTimeModel extends DeliveryTimeModel {
  const factory _DeliveryTimeModel(
      ...
      final String? created_at,
      final String? updated_at,
      final String? deleted_at}) = _$_DeliveryTimeModel;
  const _DeliveryTimeModel._() : super._();
