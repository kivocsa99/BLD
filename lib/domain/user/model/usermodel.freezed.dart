    ...
    return _then(_value.copyWith(
      ...
      projects: freezed == projects
          ...
          : projects // ignore: cast_nullable_to_non_nullable
              as List<UserProjectsModel>?,
      customer_orders: freezed == customer_orders
...
class _$_UserModel extends _UserModel {
  ...
  final List<UserProjectsModel>? _projects;
  @override
  List<UserProjectsModel>? get projects {
  ...
  final List<CustomerOrderModel>? _customer_orders;
  @override
  List<CustomerOrderModel>? get customer_orders {
    final value = _customer_orders;
    if (value == null) return null;
    if (_customer_orders is EqualUnmodifiableListView) return _customer_orders;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
